...
while (true) {
    ...
    // Verificar mensagens novas a cada 5 segundos
    if ($agora - $ultima_verificacao >= 5) {
        ...
        $sql = "SELECT 
            ...
            AND data_hora > DATE_SUB(NOW(), INTERVAL 3 MINUTE)
        ...
        $sql_logs = "SELECT 
            ...
            AND data_log > DATE_SUB(NOW(), INTERVAL 3 MINUTE)
        ...
        if ($logs_result && $logs_result->num_rows > 0) {
            ...
            while ($log = $logs_result->fetch_assoc()) {
                ...
                $resp = substr($log['resposta_ana'], 0, 40) . (strlen($log['resposta_ana']) > 40 ? '...' : '');
                
                echo "   $hora | $acao | Enviada: $msg | Resposta: $resp\n";
            }
            echo "\n";
        }
