# Script de teste para canais WhatsApp 3000 e 3001
# Numero de teste: 554796164699

Write-Host "=== TESTE DE CANAIS WHATSAPP ===" -ForegroundColor Green
Write-Host "Numero de teste: 554796164699" -ForegroundColor Yellow
Write-Host ""

# Funcao para testar canal
function Test-Canal {
    param(
        [string]$Porta,
        [string]$SessionName,
    ...
    try {
        $mensagem_teste = "Teste de canal $CanalNome - $(Get-Date -Format 'HH:mm:ss')"
        $send_data = @{
            number = $numero_teste
        ...
        if ($send_result.success) {
            ...
            Write-Host "   ID: $($send_result.message_id)" -ForegroundColor Gray
        } else {
...
Test-Canal -Porta "3000" -SessionName "default" -CanalNome "Financeiro"

# Testar Canal 3001 (Comercial)
Test-Canal -Porta "3001" -SessionName "comercial" -CanalNome "Comercial"

Write-Host "=== TESTE CONCLUIDO ===" -ForegroundColor Green
Write-Host "Verifique o painel para ver as mensagens recebidas." -ForegroundColor Yellow 