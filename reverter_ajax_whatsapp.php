...
try {
    ...
    $porta = $_GET['porta'] ?? $_POST['porta'] ?? '3000'; // Padrão porta 3000 (financeiro)
    ...
    error_log("[WhatsApp Ajax Debug] Action: $action, Method: " . ($_SERVER['REQUEST_METHOD'] ?? 'CLI') . ", VPS URL: $vps_url, Base URL: $base_url");
