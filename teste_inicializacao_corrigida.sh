...
# 🧪 TESTE DA INICIALIZAÇÃO CORRIGIDA - WHATSAPP API
# Executar no VPS: ssh root@212.85.11.238 && cd /var/whatsapp-api
# chmod +x teste_inicializacao_corrigida.sh && ./teste_inicializacao_corrigida.sh

echo "🧪 TESTE DA INICIALIZAÇÃO CORRIGIDA - WHATSAPP API"
echo "================================================="
echo ""
...
log_info "Reiniciando processos com inicialização corrigida..."
pm2 start ecosystem.config.js

log_info "Aguardando inicialização das sessões..."
sleep 10
...
echo ""
echo "🔍 ETAPA 3: VERIFICAR LOGS DE INICIALIZAÇÃO"
echo "==========================================="

log_info "Logs de inicialização da porta 3000 (últimas 15 linhas):"
pm2 logs whatsapp-3000 --lines 15 --nostream

log_info "Logs de inicialização da porta 3001 (últimas 15 linhas):"
...
PAYLOAD_DEFAULT='{"sessionName":"default","number":"5511999999999","message":"Teste inicialização corrigida - Default"}'
PAYLOAD_COMERCIAL='{"sessionName":"comercial","number":"5511999999999","message":"Teste inicialização corrigida - Comercial"}'
...
echo ""
echo "📋 RESUMO DA INICIALIZAÇÃO CORRIGIDA"
echo "===================================="
...
echo "   - 🚩 [STARTUP] Porta 3000 → sessão=\"default\""
echo "   - 🚩 [STARTUP] Porta 3001 → sessão=\"comercial\""
echo "   - ✅ initializeWhatsApp(default) chamado"
echo "   - ✅ initializeWhatsApp(comercial) chamado"
echo "   - 📱 Inicializando sessão: default/comercial"
echo "   - 🔍 [DEBUG] whatsappClients[default/comercial] criado"
...
echo "1. Verifique se os logs mostram a inicialização:"
echo "   pm2 logs whatsapp-3000 --lines 20"
echo "   pm2 logs whatsapp-3001 --lines 20"

echo ""
echo "2. Verifique se as sessões foram criadas:"
echo "   curl -s http://127.0.0.1:3000/sessions | jq ."
echo "   curl -s http://127.0.0.1:3001/sessions | jq ."

echo ""
echo "3. Se necessário, reinicie novamente:"
echo "   pm2 restart all"

echo ""
log_success "🧪 TESTE DA INICIALIZAÇÃO CORRIGIDA FINALIZADO!" 