...
<head>
    ...
    <title>Configuração IA - Pixel12 Digital</title>
...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-800">🤖 Configuração da IA</h1>
            <p class="text-gray-600 mt-2">Configure a integração com seu painel de IA para atendimento inteligente</p>
        </div>
