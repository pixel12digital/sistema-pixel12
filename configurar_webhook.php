<?php
/**
 * CONFIGURADOR DE WEBHOOK WHATSAPP
 * 
 * Este script configura o webhook no servidor WhatsApp para enviar
 * mensagens recebidas para o sistema PHP
 */

echo "=== CONFIGURADOR DE WEBHOOK WHATSAPP ===\n\n";

// Configurações
$whatsapp_server = 'http://212.85.11.238:3000';
$webhook_url = 'http://localhost:8080/loja-virtual-revenda/api/webhook.php';

echo "1. Verificando status do servidor WhatsApp...\n";
...
echo "\n🔧 PARA TESTAR AGORA:\n";
echo "php teste_webhook_corrigido.php\n";
?> 