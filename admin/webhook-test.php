    ...
    <div class="min-h-screen py-8 px-4">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-3xl font-bold text-white mb-2"><?php echo $page_title; ?></h1>
                    <p class="text-white opacity-75">Interface completa para testes de webhooks e integrações</p>
                </div>
                <div class="flex space-x-3">
                    <button type="button" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md flex items-center gap-2" onclick="executarTodosOsTestes()">
                        <span>🧪 Executar Todos os Testes</span>
                    </button>
                    <button type="button" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md flex items-center gap-2" onclick="limparLogs()">
                        <span>🗑️ Limpar Logs</span>
                    </button>
                    <a href="index.php" class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded-md flex items-center gap-2">
                        <span>🏠 Voltar</span>
                    </a>
                </div>
            </div>
